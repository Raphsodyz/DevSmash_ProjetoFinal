...
namespace DevSmash___Projeto_Final.Controllers
{
    public class ServicosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao,Nome,valor")] Servicos servicos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descricao,Nome,valor")] Servicos servicos)
        {
            if (id != servicos.Id)
            {
                return NotFound();
